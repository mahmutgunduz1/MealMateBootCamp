...
class FavorilerAdapter(
    ...
    inner class FavoriAdapterTutucu(var binding: FavorilerAdapterBinding) :
    ...
    override fun onBindViewHolder(
        ...
        Glide.with(mContext)
            .load("http://kasimadalan.pe.hu/yemekler/resimler/${favoriler.yemek_resim_adi}")
            .override(300, 300).into(t.textMealImage)
