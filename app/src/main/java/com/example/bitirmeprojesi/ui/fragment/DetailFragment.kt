...
class DetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        yemekNesnesi?.let { yemekItem ->
            ...
            Glide.with(binding.imageDetail).load(imageUrl).override(300, 300)
                .into(binding.imageDetail)

            binding.buttonDetayHeart.setOnClickListener {
                try {
                    val favori = FavoriYemekler(
                        yemekItem.yemek_adi,
                        yemekItem.yemek_resim_adi,
                        yemekItem.yemek_id,
                        yemekItem.yemek_fiyat
                    )
                    viewModel.favoriyemekEkle(favori)
                    Snackbar.make(
                        it,
                        "${yemekItem.yemek_adi} favorilere eklendi",
            ...
            binding.textAddBacket.setOnClickListener { view ->
                ...
                Snackbar.make(view, "${yemekItem.yemek_adi} karta eklendi!", Snackbar.LENGTH_SHORT)
                    .show()
            }
            ...
            binding.buttonPlus.setOnClickListener {
                viewModel.increaseQuantity(
                    currentYemek.yemek_adi,
                    currentYemek.yemek_resim_adi,
                    currentYemek.yemek_fiyat
                )
            }
